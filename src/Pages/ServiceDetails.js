...
const ServiceDetails = () => {
  ...
  const sortedData = serviceDatas.filter((item) =>
            ...
            <div className="row">
              <div className="col-lg-8">
                {sortedData.map((detailsData, index) => (
                  <div
                    key={index}
                    className="ltn__page-details-inner ltn__service-details-inner">
                    <div className="ltn__blog-img">
                      <img src={detailsData.BannerUrl} alt="Image" />
                    </div>
                    <p>
                      <span className="ltn__first-letter">
                        {detailsData?.serviceDetailOne[0]}
                      </span>
                      {detailsData.serviceDetailOne.slice(
                        1,
                        detailsData?.serviceDetailOne.length
                      )}
                    </p>
